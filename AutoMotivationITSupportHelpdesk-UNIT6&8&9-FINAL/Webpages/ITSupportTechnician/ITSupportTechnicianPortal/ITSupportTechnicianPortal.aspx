...
<body>
  ...
  <div class="p-3">
    <h3 class="text-center p-3 fw-bold bg-light rounded fw-bold text-decoration-underline">Hello! <asp:Label ID="lb_Username" runat="server"></asp:Label> these are your Services</h3>
    <div class="row">
      ...
      <div class="card text-center rounded-start">
        ...
        <div class="card-body d-flex flex-column justify-content-center align-items-center">
          ...
          <asp:Button ID="btn_View_Assigned_Tickets" Text="VIEW ASSIGNED TICKETS" CssClass="btn btn-secondary mx-auto" runat="server" Width="300px" Height="50" OnClick="btn_View_Assigned_Tickets_Click" />
        </div>
      </div>
        ...
        <div class="card-body d-flex flex-column justify-content-center align-items-center">
          ...
          <asp:Button ID="btn_Technicians_Assign_Tickets" Text="ASSIGN TICKETS" CssClass="btn btn-secondary mx-auto" runat="server" Width="300px" Height="50" OnClick="btn_Technicians_Assign_Tickets_Click"  />
        </div>
      </div>
