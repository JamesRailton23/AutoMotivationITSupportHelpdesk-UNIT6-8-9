            ...
            <div class="p-3">
                ...
                <div class="card-group">
                    <div class="card text-center rounded-start">
                        <asp:Image ID="img_New_Support_Ticket" runat="server" ImageUrl="ticket_icon.png" Width="500" Height="500" CssClass="card-img-top" />
                    ...
                    <div class="card text-center">
                        <asp:Image ID="img_View_Submitted_Tickets" runat="server" ImageUrl="magnifier_search_zoom_icon.png" Width="500" Height="500" CssClass="card-img-top" />
                        <div class="card-body d-flex flex-column justify-content-center align-content-center ">
