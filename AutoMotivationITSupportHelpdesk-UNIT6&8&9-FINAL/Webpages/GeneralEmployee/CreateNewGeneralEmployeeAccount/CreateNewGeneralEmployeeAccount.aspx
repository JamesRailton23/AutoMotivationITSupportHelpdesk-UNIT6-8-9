<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CreateNewGeneralEmployeeAccount.aspx.cs" Inherits="AutoMotivationITSupportHelpdesk_UNIT6_8_9_FINAL.Webpages.GeneralEmployee.CreateNewGeneralEmployeeAccount.CreateNewGeneralEmployeeAccount" %>
    ...
    <form id="form1" runat="server">
        <div class="container my-5 bg-dark rounded shadow p-5" style="font-family: 'IBM Plex Sans', sans-serif; background-color: #d3d3d3">
            <div class="row p-5 shadow rounded text-center justify-content-center align-content-center bg-white">
                ...
                <div class="row justify-content-center align-items-center">
                <asp:Button ID="btn_Back_To_Home" runat="server" Text="RETURN HOME" CssClass="btn btn-primary btn-lg my-5" Width="550" Height="60" OnClick="btn_Back_To_Home_Click"/>
                    </div>
            </div>
        </div>
    </form>
